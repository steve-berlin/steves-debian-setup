...
bash installers/tmux_setup/profile-tmux-startup.sh    # diagnose slow tmux startup (read-only)
...
installers/                 utils.sh, check-setup.sh, install-anki.sh, install-ly.sh, check-ly.sh,
  ...
  tmux_setup/               install-tmux-immortal.sh / -dim.sh / profile-tmux-startup.sh
